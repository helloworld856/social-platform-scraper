    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            [
                ...
                FieldSpec("youtube_max_results", "YouTube 每词最大采集数", kind="int", default=10, minimum=1, maximum=5000,
                          tooltip="每个关键词在 YouTube 上最多采集多少条结果。设得越大测算越准，但耗时越长。"),
                FieldSpec("tiktok_max_videos", "TikTok 每词最大采集数", kind="int", default=10, minimum=1, maximum=5000,
                          tooltip="每个关键词在 TikTok 上最多抓取多少个视频。"),
                FieldSpec("x_max_scrolls", "X (Twitter) 每词最大滚动数", kind="int", default=2, minimum=1, maximum=5000,
